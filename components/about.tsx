    ...
    <div className="bg-gray-900 min-h-100vh clear-both flex align-center justify-center mt-28">
        <div className="flex flex-col align-center justify-center text-center mx-10 mt-10 mb-10">
            ...
            Currently, I am also exploring <span className="text-purple-500">Python</span> and experimenting with various things like scraping and AI.</p> */}
                <p>My name is <span className="text-blue-500">Daniel Wagner</span> and I am a <span className="text-blue-500">web developer</span>.
                ...
                I have built and maintain my own <span className="text-blue-500">network</span> at home where I host my applications, including this website which runs on a cluster of dedicated Dell and HP servers that are virtualized using <span className="text-blue-500">Proxmox</span>.
